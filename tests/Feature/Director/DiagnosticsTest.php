...
class diagnosticsTest extends TestCase
{
    ...
    {
        $checkpoint = factory(Diagnostic::class)->create();

        $response = $this
            ->actingAs(factory(User::class)->make())
            ->get('/director/diagnostics/' . $checkpoint->id, ['Accept' => 'application/json']);
    ...
    public function testUpdate()
    {
        ...
        $response = $this
            ->actingAs(factory(User::class)->make())
            ->patch('/director/diagnostics/' . $checkpoint->id, [
    ...
    public function testDelete()
    {
        ...
        $response = $this
            ->actingAs(factory(User::class)->make())
            ->delete('/director/diagnostics/' . $checkpoint->id);
        ...
        $deleted = Diagnostic::withTrashed()->find($checkpoint->id);
